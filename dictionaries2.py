#Create a Key, storing multiple values in Lists --within a dictionary
students = {
    "Alice": ["ID0001", 26, "A"], 
    "Bob": ["ID0002", 27, "B"], 
    "Claire": ["ID0003", 17, "C"], 
...
#Create multiple dictionaries within a dictionary, giving each key a dictionary as a value
students = {
...
print(students["Emma"]["id"]), print(students["Emma"]["grade"])